...
const ChapterListCard = ({
  ...
  return (
    <Link key={id} href={`/${id}`} target="_blank" className="group">
      <div className="flex dark:bg-red-500 bg-white  group-hover:border-cyan-600 group-hover:bg-gray-100  w-full  flex-row align-middle justify-between border border-solid border-gray-200 rounded cursor-pointer p-4">
