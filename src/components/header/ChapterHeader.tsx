...
const ChapterHeader = ({ chapterId }: ChapterHeaderProps) => {
  ...
  return (
    <div className="flex bg-white dark:bg-gray-600 group-hover:border-cyan-600 group-hover:bg-gray-100  w-full  flex-row align-middle justify-between border border-solid border-gray-200 rounded cursor-pointer p-4">
      <div className="flex flex-row align-middle w-1/3">
        ...
        <div className="flex flex-col ">
          ...
          <div className="text-xs font-bold text-gray-500 dark:text-gray-300 group-hover:text-cyan-600">
      ...
      <div className="flex flex-col text-center w-1/3 dark:text-gray-50">
        ...
        <div className="font-sans font-bold text-[0.7rem] text-gray-500 dark:text-gray-300  group-hover:text-cyan-600">
      ...
      <div className="flex flex-row align-middle justify-end w-1/3">
        <div className="flex flex-col ">
          ...
          <div className="text-xs font-bold text-gray-500 dark:text-gray-300 group-hover:text-cyan-600 text-center">
            Order {chapter?.revelation_order}
          </div>
        </div>
        <div className="flex rounded  group-hover:bg-cyan-600 group-hover:text-white bg-gray-100 dark:bg-cyan-800 align-middle justify-center rotate-45 border border-solid round ms-5  w-10 h-10">
          <span className="-rotate-45 my-auto font-bold align-baseline leading-5 justify-center m-0 p-0  text-gray-500 dark:text-gray-200">
            {chapter?.id}
          </span>
        </div>
